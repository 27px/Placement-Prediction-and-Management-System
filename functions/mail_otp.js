  ...
  return `
      <div style="width:100%;text-align:center;">
        ...
        <div style="width:100%;height:auto;min-height:400px;background:#212121;color:#FFF;padding:50px 20px;box-sizing:border-box;">
          ...
          <div style="font-family:sans-serif;margin:10px 0px;">Your OTP is</div>
        ...
        <div>
          <div style="font-size:16px;font-weight:900;font-family:monospace;padding:20px 10px;letter-spacing:1px;">Developed By</div>
