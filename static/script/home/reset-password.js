...
const ce = (
    ...
    if (!!className)
        element.setAttribute(
            "class",
            typeof className == typeof [] ? className.join(" ") : className
        );
    if (!!id) element.id = id;
...
const newForm = (email) => {
    ...
    form.appendChild(
        ce("input", undefined, "otp-input", undefined, undefined, {
            placeholder: "OTP",
        })
    );
    form.appendChild(
        ce("input", undefined, "new-password", undefined, undefined, {
            type: "password",
    ...
    form.appendChild(
        ce("input", undefined, "confirm-password", undefined, undefined, {
            type: "password",
